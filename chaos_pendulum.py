...
def calculate_trajectory(n_iter,dt,theta1_init,theta2_init,theta1_d_init,theta2_d_init,m1=1,m2=1,l1=1,l2=0.5,g=10,add_energy=None):
	...
	for i in range(n_iter-1):
		...
		if add_energy is not None:
			phase_traject[i,2]+=np.sign(phase_traject[i,2])*1e-5
		#---explicite Euler ----
...
def render_phase_traject(phase_traject,img_res=1,m1=1,m2=1,l1=1,l2=0.5,g=10,save_path='trash_figures/',take_frame_every=1,second_phase_traject=None,draw_phase=True,draw_marker=True,max_points=500,frames_per_second=20):
	frames=[]
...
# phase_traject_2=calculate_trajectory(n_iter,dt,theta1_init+1e-2,theta2_init+1e-2,theta1_d_init,theta2_d_init,m2=m2)
print('render phase trajectory...')
e_pot,e_kin=render_phase_traject(phase_traject,img_res=2,take_frame_every=take_frame_every,m2=m2,second_phase_traject=None,draw_phase=True,draw_marker=True,max_points=100,frames_per_second=frames_per_second)
